...
GENERATION_SYSTEM_PROMPT = (
    ...
    "- Format: (INDEX__TOPIC - FileName) where FileName is the actual document filename from the context\n"
    "- ALWAYS include the filename after the ' - ' separator — never cite just the index name alone\n"
    "- Example: (novembre (customer care)__05_retours_et_sav - Procédures Réclamations Qualité)\n"
